/* Copyright (C) 2009 Abdulla Kamar. All rights reserved. */
	...
	#ifndef OOE_EXTERNAL_NIPC_RPC_FORWARD_HPP
	#define OOE_EXTERNAL_NIPC_RPC_FORWARD_HPP
...
//--- nipc ---------------------------------------------------------------------
	...
	#define BOOST_PP_FILENAME_1 "external/nipc/rpc_forward.hpp"
	#include BOOST_PP_ITERATE()
	#undef BOOST_PP_FILENAME_1
	#undef BOOST_PP_ITERATION_LIMITS

	#endif	// OOE_EXTERNAL_NIPC_RPC_FORWARD_HPP
