...
#ifndef OOE_PLATFORM_POSIX_FOUNDATION_VIDEO_EVENT_QUEUE_FORWARD_HPP
#define OOE_PLATFORM_POSIX_FOUNDATION_VIDEO_EVENT_QUEUE_FORWARD_HPP
...
#endif	// OOE_PLATFORM_POSIX_FOUNDATION_VIDEO_EVENT_QUEUE_FORWARD_HPP
